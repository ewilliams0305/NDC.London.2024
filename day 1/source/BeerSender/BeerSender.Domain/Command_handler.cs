...
public abstract class Command_handler<TAggregate, TCommand> where TAggregate : Aggregate
{
    ...
    /// <returns></returns>
    protected abstract IEnumerable<object> HandleInternal(TAggregate aggregate, TCommand command);
