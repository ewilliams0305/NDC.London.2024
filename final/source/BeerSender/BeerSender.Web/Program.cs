...
{
    //options.UseMySQL("server=127.0.0.1;database=beer_read;user=root;password=B@nanaPh0n3");
...
{
    //options.UseMySQL("server=127.0.0.1;database=beer_events;user=root;password=B@nanaPh0n3");
